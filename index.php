...
$ControllerName = ucfirst(strtolower($_REQUEST['controller']).'Controller'); //Lấy tên của Controller truyền vào rồi chuyển về chữu thường rồi viết hoa chữ đầu gắn thêm Controller vd(ProductController), mặc định controller truyền vào là index
