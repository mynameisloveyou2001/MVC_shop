                                    ...
                                    <?php if (!empty($categories)): ?>
                                     <?php foreach ($categories as $value): ?>
                                      <li class="category-item" id="getcolor">
                                       <a href="index.php?controller=product&action=index&id=<?=$value['id']?>" class="category-item__link"><?=$value['name']?></a>
                                   </li>
                               <?php endforeach ?>   
                           <?php endif ?>
                      ...
                      <div class="select-input">
                         ...
                         <ul class="select-input__list">
                            <li class="select-input__item">
                               <a href="?controller=product&action=index&sort=desc" class="select-input__link">Giá: thấp đến cao</a>
                           </li>

                           <li class="select-input__item">
                               <a href="?controller=product&action=index&sort=asc" class="select-input__link">Giá: cao đến thấp</a>
                           </li>
                       </ul>
                   </div>
