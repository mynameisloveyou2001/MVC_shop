...
<div class="buttonhead" style="margin: 192px 0 0 0;"><a  style="text-decoration: none; color: white; font-size: medium;" href="?controller=product&action=home">Trở lại</a>
</div>
</div>
...
<div class="formOrder" style="margin: 10px 0 0 55px;" >
   <form style="flex-direction: column;" action="?controller=admin&action=update" method="POST" enctype="multipart/form-data">
    ...
    <input  required class="inputorder" type="file" name="img" value=""></br>
    <label class="inputorder">Tên</label>
    <input  required class="inputorder" type="text" name="fullname" value="<?=$data['fullname']?>"></br>
    <label class="inputorder">Điện thoại</label>
    <input  required class="inputorder" type="text" name="phone" value="<?=$data['phone']?>"></br>
